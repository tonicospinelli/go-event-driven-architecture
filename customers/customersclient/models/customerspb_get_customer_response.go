...
func (m *CustomerspbGetCustomerResponse) validateCustomer(formats strfmt.Registry) error {
...
func (m *CustomerspbGetCustomerResponse) contextValidateCustomer(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CustomerspbGetCustomerResponse) UnmarshalBinary(b []byte) error {
	var res CustomerspbGetCustomerResponse
