...
func (o *CreateCustomerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateCustomerOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/customers][%d] createCustomerOK %s", 200, payload)
}
...
func (o *CreateCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/customers][%d] createCustomer default %s", o._statusCode, payload)
}
