...
func (m *OrderingpbCreateOrderRequest) validateItems(formats strfmt.Registry) error {
...
func (m *OrderingpbCreateOrderRequest) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderingpbCreateOrderRequest) UnmarshalBinary(b []byte) error {
	var res OrderingpbCreateOrderRequest
